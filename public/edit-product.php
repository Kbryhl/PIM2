    ...
    <main class="container layout narrow">
        <section class="card">
            ...
            <form id="editProductForm" class="import-form">
                ...
                <input id="stkPrKolli" name="stk_pr_kolli" type="number" min="0" step="1" />

                <label for="stkQuarterPl">Stk 1/4 pl</label>
                <input id="stkQuarterPl" name="stk_1_4_pl" type="number" min="0" step="1" />

                <label for="stkHalfPl">Stk 1/2 pl</label>
                <input id="stkHalfPl" name="stk_1_2_pl" type="number" min="0" step="1" />

                <label for="stkFullPl">Stk 1/1 pl</label>
                <input id="stkFullPl" name="stk_1_1_pl" type="number" min="0" step="1" />
                ...
                <input id="bestilInterval" name="bestil_interval" type="number" min="0" step="1" />
